 ...
 *
 * Use without arguments to inject the full `JwtUser`, or pass a `JwtUser` key to inject only that
 * field.
 *
 ...
 * @returns The full authenticated user object, the selected user property, or `undefined` when
 *          no user is attached.
 */
